...
class Mahasiswa{
    ...
    public function __construct(string $nim, string $nama, string $tglLahir, string $jenisKelamin, string $alamat, string $noTelepon, string $namaKelas){
        $this->nim = $nim;
        $this->nama = $nama;
    ...
    public function setTglLahir(string $tglLahir): void{
        $this->tglLahir = $tglLahir;
    }
